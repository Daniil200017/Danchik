...
def banner(console):
    ...
    console.print("[bold green]cpmhacker[/bold green]: Car Parking Multiplayer Hacking Tool.")
    console.print(f"")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold cyan](10): Delete Friends[/bold cyan]")
            console.print("[bold cyan](11): Unlock Paid Cars[/bold cyan]")
            console.print("[bold cyan](12): Unlock all Cars[/bold cyan]")
            console.print("[bold cyan](13): Unlock all Cars Siren[/bold cyan]")
            ...
            console.print("[bold cyan](18): Unlock House 3[/bold cyan]")
            ...
            if service == 0: # Exit
                ...
                console.print("[bold cyan][%] Saving your data[/bold cyan]: ", end=None)
                if len(new_id) >= 8 and len(new_id) <= 14 and (' ' in new_id) == False:
